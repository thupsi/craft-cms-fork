...
return [
    ...
    '1 job' => '1 εργασία',
    '<a>Renew now</a> for another year of updates.' => '<a>Ανανεώστε τώρα</a> για ένα ακόμα έτος ενημερώσεων.',
    '<span class="visually-hidden">Characters left:</span> {chars, number}' => '<span class="visually-hidden">Εναπομείναντες χαρακτήρες:</span> {chars, number}',
    '<strong>Your license has expired!</strong> Renew your {name} license for another year of amazing updates.' => '<strong>Η αδειά σας έχει λήξει!</strong> Ανανεώστε την {name} άδεια για ένα ακόμα έτος φανταστικών ενημερώσεων.',
    '<strong>You’ve reached a breakpoint!</strong> More updates will become available after you install {update}.' => '<strong>Έχετε φτάσει σε ένα breakpoint!</strong> Περισσότερες ενημερώσεις θα είναι διαθέσιμες αφού εγκαταστήσετε το {update}.',
    'A critical update is available.' => '΄Μία κρίσιμη ενημέρωση είναι διαθέσιμη.',
    'A fatal error has occurred:' => 'Συνέβει ένα κρίσιμο σφάλμα:',
    'A file with the name “{filename}” already exists.' => 'Ένα αρχείο με το όνομα “{filename}” υπάρχει ήδη.',
    'A folder with the name “{folderName}” already exists in the folder.' => 'Ένας φάκελος με το όνομα “{folderName}” υπάρχει ήδη στο φάκελο.',
    'A folder with the name “{folderName}” already exists in the volume.' => 'Ένας φάκελος με το όνομα “{folderName}” υπάρχει ήδη στον τόμο.',
    'A license key is required.' => 'Απαιτείται ένα κλειδί άδειας.',
    'A server error occurred.' => 'Συνέβει σφάλμα διακομιστή.',
    'A source is required when relating ancestors.' => 'Απαιτείται πηγή όταν συσχετίζονται πρόγονοι.',
    'A subpath is required for this filesystem.' => 'Απαιτείται υποδιαδρομή για αυτό το σύστημα αρχείων.',
    'A template name cannot contain NUL bytes.' => 'Mια ονομασία template δε μπορεί να περιέχει NUL bytes.',
    'Abandoned' => 'Εγκαταλειμμένος',
    'Abort the update' => 'Απενεργοποιήστε την ενημέρωση',
    'Access the control panel when the system is offline' => 'Πρόσβαση στον πίνακα ελέγχου όταν το σύστημα είναι εκτός σύνδεσης',
    'Access the control panel' => 'Πρόσβαση στον πίνακα ελέγχου',
    'Access the site when the system is off' => 'Πρόσβαση στον ιστότοπο όταν το σύστημα είναι απενεργοποιημένο',
    ...
    'Account locked. Try again in {time}.' => 'Ο λογαριασμός είναι κλειδωμένος. Δοκιμάστε ξανά σε {time}.',
    'Account locked.' => 'Ο λογαριασμός είναι κλειδωμένος.',
    'Account suspended.' => 'Ο λογαριασμός έχει ανασταλεί.',
    'Account' => 'Λογαριασμός',
    'Accounts with this permission could use it to escalate their own permissions.' => 'Οι λογαριασμοί με αυτήν την άδεια θα μπορούσαν να το χρησιμοποιήσουν για να κλιμακώσουν τα δικά τους δικαιώματα.',
    'Action' => 'Δράση',
    'Actions' => 'Ενέργειες',
    'Activate account' => 'Ενεργοποιήστε τον λογαριασμό',
    'Activation email sent.' => 'Αποστέλλονται email ενεργοποίησης.',
    'Active Installs' => 'Ενεργές εγκαταστάσεις',
    'Active Trials' => 'Ενεργές δοκιμές',
    'Active trials added to the cart.' => 'Ενεργές δοκιμές που προστέθηκαν στο καλάθι.',
    'Active' => 'Ενεργός',
    'Activity' => 'Δραστηριότητα',
    'Add Row Label' => 'Προσθήκη Ετικέτας Γραμμής',
    'Add a category' => 'Προσθέστε μια κατηγορία',
    'Add a color' => 'Προσθέστε ένα χρώμα',
    'Add a column' => 'Προσθέστε μια στήλη',
    'Add a filter' => 'Προσθέστε ένα φίλτρο',
    'Add a passkey' => 'Προσθέστε ένα passkey',
    'Add a row' => 'Προσθέστε μια γραμμή',
    'Add a rule' => 'Προσθέστε έναν κανόνα',
    'Add a tag' => 'Προσθέστε μια ετικέτα',
    'Add a token' => 'Προσθέστε ένα token',
    'Add a user' => 'Προσθέστε έναν χρήστη',
    'Add all to cart' => 'Προσθέστε όλα στο καλάθι',
    'Add an asset' => 'Προσθέστε ένα αρχείο',
    'Add an entry' => 'Προσθέστε μια καταχώρηση',
    'Add an option' => 'Προσθέστε μια επιλογή',
    ...
    'Address fields saved.' => 'Τα πεδία διευθύνσεων αποθηκεύτηκαν.',
    'Address' => 'Διεύθυνση',
    'Addresses' => 'Διευθύνσεις',
    'Add…' => 'Προσθήκη…',
    'Admin' => 'Διαχειριστής',
    'Administrate users' => 'Διαχείριση χρηστών',
    'Administrative Area' => 'Διαχειριστική Περιοχή',
    'Admins' => 'Διαχειριστές',
    ...
    'All done!' => 'Ολοκληρώθηκε!',
    'All done' => 'Ολοκληρώθηκε',
    'All elements' => 'Όλα τα στοιχεία',
    'All entries' => 'Όλες οι καταχωρήσεις',
    'All jobs released.' => 'Όλες οι εργασίες ελευθερώθηκαν.',
    'All option labels must be unique.' => 'Όλες οι ετικέτες επιλογών πρέπει να είναι μοναδικές.',
    'All option values must be unique.' => 'Όλες οι τιμές επιλογής πρέπει να είναι μοναδικές.',
    'All plugins must be compatible with Craft {version} before you can upgrade.' => 'Όλα τα plugins πρέπει να είναι συμβατά με το Craft {έκδοση} πριν μπορέσετε να αναβαθμίσετε.',
    'All targets must have a label.' => 'Όλοι οι στόχοι πρέπει να έχουν μια ετικέτα.',
    'All users' => 'Όλοι οι χρήστες',
    'All' => 'Ολα',
    'Allow Upscaling' => 'Να επιτρέπεται η μεγέθυνση',
    'Allow line breaks' => 'Να επιτρέπονται τα line breaks',
    'Allow public registration' => 'Να επιτρέπεται η δημόσια εγγραφή',
    'Allow self relations' => 'Να επιτρέπεται η συχέτιση με το ίδιο στοιχείο',
    'Allow subfolders' => 'Να επιτρέπονται οι υποφάκελοι',
    'Allow uploading directly to the field' => 'Να επιτρέπεται η μεταφόρτωση απευθείας στο πεδίο',
    'Allowed File Types' => 'Επιτρεπόμενοι τύποι αρχείων',
    'Allowed Link Types' => 'Επιτρεπόμενοι τύποι συνδέσμων',
    'Allows creating drafts of new {type}.' => 'Επιτρέπει τη δημιουργία προσχεδίων τύπου {type}.',
    'Allows fully saving canonical {type} (directly or by applying drafts).' => 'Επιτρέπει την πλήρη αποθήκευση του canonical {Type} (απευθείας ή με την εφαρμογή προσχεδίων).',
    'Allows viewing existing {type} and creating drafts for them.' => 'Επιτρέπει την προβολή των υφιστάμενων {type} και τη δημιουργία προσχεδίων για αυτά.',
    'Already in your cart' => 'Ήδη στο καλάθι σας',
    'Alternative Text' => 'Εναλλακτικό κείμενο',
    'Always show focus rings' => 'Να φαίνονται πάντα τα focus rings',
    'Amber' => 'Κεχριμπάρι',
    'An error occurred when duplicating the category.' => 'Παρουσιάστηκε σφάλμα κατά την κλωνοποίηση της κατηγορίας.',
    'An error occurred when duplicating the entry.' => 'Παρουσιάστηκε σφάλμα κατά την κλωνοποίηση της καταχώρησης.',
    'An error occurred when installing {name}.' => 'Παρουσιάστηκε σφάλμα κατά την εγκατάσταση {name}.',
    'An error occurred while processing your request.' => 'Παρουσιάστηκε σφάλμα κατά την επεξεργασία του αιτήματός σας.',
    'Ancestors' => 'Πρόγονοι',
    'Announcements' => 'Ανακοινώσεις',
    'Any changes will be lost if you leave this page.' => 'Οποιεσδήποτε αλλαγές θα χαθούν εάν αφήσετε αυτήν τη σελίδα.',
    'Anything cached with `Craft::$app->cache->set()`' => 'Οτιδήποτε έγινε cached με `Craft::$app->cache->set()`',
    'Application Info' => 'Πληροφορίες εφαρμογής ',
    'Applied new migrations successfully.' => 'Τα νέα migrations εφαρμόστηκαν με επιτυχία.',
    'Applied “{name}”' => 'Εφαρμόστηκε “{name}”',
    'Applied' => 'Εφαρμόστηκε',
    'Apply Time' => 'Εφαρμογή Ώρας',
    'Apply YAML Changes' => 'Εφαρμογή Μεταβολών YAML',
    'Apply YAML changes' => 'Εφαρμογή μεταβολών YAML',
